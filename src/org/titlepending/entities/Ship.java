...
public class Ship extends Entity {
    protected int healthcount = 100;
    protected Vector velocity;
    protected float direction;
    protected Animation ship;
    protected Animation sail;
    protected Animation cannon;
    protected int stats[] = new int[4];//hull,sail,cannon,crew... Get these numbers from another state
